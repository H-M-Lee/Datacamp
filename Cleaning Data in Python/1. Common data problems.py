...
*Numeric data types: Number of items bought in a basket; Number of points on cunstomer loyalty card; Salary earned monthly;
*Text: First name; City of residence; Shipping address of a customer;
*Dates: Birthdates of clients; Order date of a product;
