...
*Membership Constraint: A has_loan column wihh the value 12.; A GPA column containing a Z- grade.; A month column with the value 14.; A day_of_week column with the value Suntermonday.;
*Other Constraint: A birthdate column with values in the future.; An age column with values above 130.; A revenue column represented as a string.;
...
*White spaces and inconsistency: .str.lower(); .str.upper(); .str.strip();
*Creating or remapping categories: pandas.cut(); .replace(); pandas.qcut();
